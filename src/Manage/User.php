...
class User
{
	...
	{
		$res = self::httpsGet(Uri::USER_DELETE, [Config::$token, $userId]);
	...
	{
		$res = self::httpsGet(Uri::USER_GET, [Config::$token, $userId]);
	...
	{
		$res = self::httpsGet(Uri::USER_SIMPLE_LIST, [Config::$token, $depId, $fetch, $state]);
	...
	{
		$res = self::httpsGet(Uri::USER_LIST, [Config::$token, $depId, $fetch, $state]);
	...
	{
		$res = self::httpsGet(Uri::USER_INFO, [Config::$token, $code]);
