...
class User extends Manager
{
	...
	{
		$res = self::httpsGet(Uri::USER_GET, [$this->token, $userId]);
	...
	{
		return self::httpsGet(Uri::USER_SIMPLE_LIST, [$this->token, $depId, boolval($fetch), $state])->userlist;
    }
	...
	{
		return self::httpsGet(Uri::USER_LIST, [$this->token, $depId, boolval($fetch), $state])->userlist;
	}

    /**
     * 根据code获取成员信息
     * @param string $code 微信授权CODE
     * @return \stdClass UserId/OpenId|DeviceId
     * @throws Exception
     */
